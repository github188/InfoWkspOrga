	...
	f
	    .extend(
	            l.prototype,
	            {
	              ...
	              qwertyLayout : [ "!@#$%^&*()_=" + c + h + e, c + "`~[]{}<>\\|/" + h + "789", "qwertyuiop'\"" + c + "456",
	                              c + "asdfghjkl;:" + h + "123", h + "zxcvbnm,.?" + h + c + "-0+", k + h + b + g + c + i + a ],
	              ...
	              _setInput : function(n, m) {
		              m._input = f(!m._inline ? n : this._get(m, "target") || '<input type="text" class="' + this._inlineEntryClass
		                                            + '" disabled="disabled"/>');
		              if (m._inline) {
			              n = f(n);
			              n.find("input").remove();
	              ...
	              _connectKeypad : function(r, q) {
		              ...
		              if (!q._inline) {
			              ...
			              if (u == "button" || u == "both") {
				              ...
				              var n = f(this._get(q, "buttonImageOnly") ? f('<img src="' + v + '" alt="' + o + '" title="' + o + '"/>')
				                                                       : f('<button type="button" title="' + o + '"></button>')
				                                                           .html(
				                                                                 v == "" ? t : f('<img src="' + v + '" alt="' + o + '" title="' + o
				                                                                                 + '"/>')));
				              s[m ? "before" : "after"](n);
	              ...
	              _destroyKeypad : function(o) {
		              ...
		              m.siblings("." + this._appendClass).remove().end().siblings("." + this._triggerClass).remove().end()
	              ...
	              _disableKeypad : function(p) {
		              ...
		              if (s == "input" || s == "textarea") {
			              ...
			              if (s == "div" || s == "span") {
				              ...
				              o.prepend('<div class="' + this._disableClass + '" style="width: ' + n.outerWidth() + "px; height: "
				                        + n.outerHeight() + "px; left: " + (r.left - q.left) + "px; top: " + (r.top - q.top) + 'px;"></div>');
				              var m = f.data(p, j);
	              ...
	              _updateKeypad : function(m) {
		              ...
		              m._mainDiv.removeClass().addClass(
		                                                this._get(m, "keypadClass") + (this._get(m, "isRTL") ? " keypad-rtl" : "")
		                                                    + (m._inline ? this._inlineClass : "")
		                                                    + " ui-widget ui-widget-content ui-corner-all ui-shadow");
	              ...
	              _checkOffset : function(p, o, n) {
		              ...
		              if (this._get(p, "isRTL") || (o.left + p._mainDiv.outerWidth() - t) > u) {
			              o.left = Math.max((n ? 0 : t), r[0] + (p._input ? p._input.outerWidth() : 0) - (n ? t : 0) - p._mainDiv.outerWidth()
			                                             - (n && f.browser.opera ? document.documentElement.scrollLeft : 0))
		              } else {
			              o.left -= (n ? t : 0)
		              }
		              if ((o.top + p._mainDiv.outerHeight() - s) > q) {
			              o.top = Math.max((n ? 0 : s), r[1] - (n ? s : 0) - p._mainDiv.outerHeight()
			                                            - (n && f.browser.opera ? document.documentElement.scrollTop : 0))
		              } else {
			              o.top -= (n ? s : 0)
		              }
		              return o
	              ...
	              _checkExternalClick : function(m) {
		              ...
		              var n = f(m.target);
		              if (!n.parents().andSelf().is("#" + f.keypad._mainDivId) && !n.hasClass(f.keypad.markerClassName)
		                  && !n.parents().andSelf().hasClass(f.keypad._triggerClass) && f.keypad._keypadShowing) {
			              f.keypad._hideKeypad(null, "")
		              }
	              },
	              ...
	              _generateHTML : function(r) {
		              ...
		              for (var p = 0; p < t.length; p++) {
			              ...
			              for (var o = 0; o < w.length; o++) {
				              ...
				              s += (w[o] == this.SPACE ? '<div class="keypad-space"></div>'
				                                      : (w[o] == this.HALF_SPACE ? '<div class="keypad-half-space"></div>'
				                                                                : '<button type="button" class="keypad-key ui-state-default'
				                                                                  + (w[o] == this.CLEAR ? " keypad-clear"
				                                                                                       : (w[o] == this.BACK ? " keypad-back"
				                                                                                                           : (w[o] == this.CLOSE ? " keypad-close"
				                                                                                                                                : (w[o] == this.SHIFT ? " keypad-shift"
				                                                                                                                                                     : (w[o] == this.ENTER ? " keypad-enter"
				                                                                                                                                                                          : (w[o] == this.SPACE_BAR ? " keypad-spacebar"
				                                                                                                                                                                                                   : ""))))))
				                                                                  + '" title="'
				                                                                  + (w[o] == this.CLEAR ? this._get(r, "clearStatus")
				                                                                                       : (w[o] == this.BACK ? this
				                                                                                                               ._get(r,
				                                                                                                                     "backStatus")
				                                                                                                           : (w[o] == this.ENTER ? this
				                                                                                                                                ...
				                                                                                                                                : (w[o] == this.CLOSE ? this
				                                                                                                                                                     ...
				                                                                                                                                                     : (w[o] == this.SHIFT ? this
				                                                                                                                                                                          ...
				                                                                                                                                                                          : "")))))
				                                                                  + '">'
				                                                                  + (w[o] == this.CLEAR ? this._get(r, "clearText")
				                                                                                       : (w[o] == this.BACK ? this._get(r,
				                                                                                                                        "backText")
				                                                                                                           : (w[o] == this.CLOSE ? this
				                                                                                                                                    ._get(
				                                                                                                                                          r,
		              ...
		              s += '<div style="clear: both;"></div>'
		                   + (!r._inline && f.browser.msie && parseInt(f.browser.version, 10) < 7 ? '<iframe src="javascript:false;" class="'
		                                                                                            + f.keypad._coverClass + '"></iframe>' : "");
		              s = f(s);
		              ...
		              }).end().not(".keypad-clear").not(".keypad-back").not(".keypad-close").not(".keypad-shift").not(".keypad-enter")
		                  .click(function() {
...
PrimeFaces.widget.Keyboard = PrimeFaces.widget.BaseWidget.extend({
	init : function(a) {
		...
		this.cfg.beforeShow = function(d, c) {
			$(d).css("z-index", ++PrimeFaces.zindex)
		};
...
PrimeFaces.widget.KeyboardUtils = {
  layouts : {
    qwertyBasic : [ $.keypad.qwertyAlphabetic[0] + $.keypad.CLOSE,
    ...
    alphabetic : [ "abcdefghij" + $.keypad.CLOSE, "klmnopqrst" + $.keypad.CLEAR,
