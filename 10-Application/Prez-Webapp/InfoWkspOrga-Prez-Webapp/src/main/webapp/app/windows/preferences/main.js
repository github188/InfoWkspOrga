...
require.config({
  ...
  paths: {
    ...
    /* ------------------------------------------------------------------------------------ 
    'preferences-screen':   'windows/preferences/preferences-screen',*/
 ...
 */
require([ 'jquery', 'windows/preferences/controller',
          ...
          'configuration', 'utilApp', 'utilDebug' // Load the module needed to initialize the application
	          ...
	          var appPreferences = new PreferencesController();
	          appPreferences.initialize();
	          appPreferences.showScreen();
          });
