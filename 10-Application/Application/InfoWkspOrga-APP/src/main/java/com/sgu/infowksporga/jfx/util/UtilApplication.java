...
/**
 * Description : UtilApplication class<br>
 */
@Slf4j
public final class UtilApplication {
  ...
  public static void setInfoWrkspOrgaAppIcon(final Window window) {
    window.setIconImage(Toolkit.getDefaultToolkit().getImage(Application.class.getResource("/images/infowrksporga-ico.png")));
  }
  ...
  public static void displayWithDesktopTool(final String uriPath) {
    final Thread thread = new Thread(new Runnable() {
      ...
      public void run() {
        try {
          final URI uri = UtilApplication.getJDesktopURI(uriPath);
   ...
   */
  public static Object callRestBusinessService(final String URI, final AbstractIn pivotIn, final Class<?> pivotOutType) {
    return callRestBusinessService(URI, pivotIn, pivotOutType, HttpMethod.POST, GMediaType.APPLICATION_JAVA_SERIALIZED_OBJECT,
