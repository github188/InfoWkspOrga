...
/**
 * The Class ViewComponentAttributesGen.
 */
public class ViewComponentAttributesGen {

  /**
   * The Constructor.
   */
  public ViewComponentAttributesGen() {
  }
  ...
  public static void main(final String[] args) {
    File baseDirectory = new File("G:\\Projects\\400-InfoWkspOrga\\10-Application\\Application\\InfoWkspOrga-APP\\src\\main");
    ...
    System.out.println("//---------------------------------");
    String fxmlFile = UtilIO.searchInDirectory(baseDirectory, "identityCardPanel.fxml");
    ...
    System.out.println("//---------------------------------");
    fxmlFile = UtilIO.searchInDirectory(baseDirectory, "configurationPanel.fxml");
    ...
    System.out.println("//---------------------------------");
    fxmlFile = UtilIO.searchInDirectory(baseDirectory, "referencePanel.fxml");
    labels = createViewFields(fxmlFile);
    labelFields.add(labels);
    ...
    System.out.println("//---------------------------------");
    fxmlFile = UtilIO.searchInDirectory(baseDirectory, "stylePanel.fxml");
    labels = createViewFields(fxmlFile);
    labelFields.add(labels);
    ...
    System.out.println("//---------------------------------");
    fxmlFile = UtilIO.searchInDirectory(baseDirectory, "horodatePanel.fxml");
    labels = createViewFields(fxmlFile);
    labelFields.add(labels);
