 ...
 *         &lt;element ref="{}practice" maxOccurs="unbounded"/>
 *       &lt;/sequence>
    ...
    implements Serializable
{
    ...
    @XmlElement(required = true)
    protected List<Practice> practice;
     ...
     * This is why there is not a <CODE>set</CODE> method for the practice property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPractice().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Practice> getPractice() {
        if (practice == null) {
            practice = new ArrayList<Practice>();
        }
