...
public class FindDataToInitApplicationController extends AbstractRestController {
  ...
  @ResponseBody
  public com.sgu.infowksporga.business.pivot.orchestration.FindDataToInitApplicationOut  findDataToInitApplication (@RequestBody(required = true) final com.sgu.infowksporga.business.pivot.orchestration.FindDataToInitApplicationIn pivotIn) {
