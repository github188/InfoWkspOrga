...
CREATE TABLE `preference` (
  ...
  `category` VARCHAR(50) NOT NULL DEFAULT 'DEFAULT' COMMENT 'On peut voir la ''category'' comme un  groupe. Regroupement d''une même famille de propriétés (ex: Adresse; Personne; ...) au sein d''un même node',
  ...
  `value` LONGTEXT  NULL COMMENT 'La valeur de la preference',
